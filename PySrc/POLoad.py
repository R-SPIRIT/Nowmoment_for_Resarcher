...
q2=dataoutlier(str("pf1.csv"),open(str(columnindexPath)+str(columnindex),'rt'))
q2.to_csv(csvPath+str("poload.csv")  , sep=',',encoding='euc-kr')
fo = open(csvPath+str("poload.csv"), 'rt')
fwo = open(csvPath+str("poload1.csv"), 'w')
lineso = fo.readlines()
for lineo in lineso:
    joo=lineo.split(",")[1:]    
    joo1=",".join(joo)
...
info = ('{},{},{},{},{}'.format(4, pyname, ID, days ,test_read_lines))
